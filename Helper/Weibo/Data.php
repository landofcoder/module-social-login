 ...
 */
namespace Lof\SocialLogin\Helper\Weibo;
...
{
    const XML_PATH_WEIBO_API_KEY = 'sociallogin/weibo/api_key';
    const XML_PATH_WEIBO_CLIENT_KEY = 'sociallogin/weibo/client_key';
    const XML_PATH_WEIBO_SEND_PASSWORD = 'sociallogin/weibo/send_password';
    ...
    {
        return $this->_getUrl('lofsociallogin/weibo/callback/', ['_secure' => $this->isSecure()]);
    }
}
