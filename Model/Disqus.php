...
use Lof\SocialLogin\Helper\Disqus\Data as DataHelper;
...
class Disqus
{
    ...
    public function getDisqusLoginUrl()
    {
        ...
        $_SESSION['wpcc_state_disqus'] = $wpcc_state;
        $url_to = 'https://disqus.com/api/oauth/2.0/authorize/'.'?' . http_build_query([
        'response_type' => 'code',
