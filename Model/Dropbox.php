...
use Lof\SocialLogin\Helper\Dropbox\Data as DataHelper;
...
class Dropbox
{
    ...
    public function getDropboxLoginUrl()
    {
        ...
        $_SESSION['wpcc_state_dropbox'] = $wpcc_state;

        $url_to = 'https://www.dropbox.com/oauth2/authorize' . '?' . http_build_query([
        'response_type' => 'code',
