...
use Lof\SocialLogin\Helper\Paypal\Data as DataHelper;
...
class Paypal
{
    ...
    public function getPaypalLoginUrl()
    {
        ...
        $_SESSION['wpcc_state_paypal'] = $wpcc_state;
        $url_to = 'https://www.paypal.com/signin/authorize?' . http_build_query([
        'response_type' => 'code',
