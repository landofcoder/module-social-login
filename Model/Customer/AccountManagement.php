 ...
 */
namespace Lof\SocialLogin\Model\Customer; 
...
class AccountManagement implements AccountManagementInterface
{
    ...
    {
        $collection = ObjectManager::getInstance()->create('Lof\SocialLogin\Model\ResourceModel\Social\Collection');

        $account = $collection->addFieldToFilter('customer_id', $customerId)->getFirstItem();

        if ($account && $account->getSocialId()) {
